...
When a client is sending its second and subsequent Keepalive Session Signaling request
...
the server can adapt its responses to better fit the client's needs.
